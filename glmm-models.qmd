...
[^1]: One can also introduce explanatory variables via a link function and
a linear predictor into the variance of the random effects, but we shall not
explore this extension in this monograph.
...
model by allowing random effects in the model for the dispersion parameter.[^2]

[^2]: One can also introduce explanatory variables via a link function and a
linear predictor into the variance of the random effects, but we do not explore
this extension in this monograph.
