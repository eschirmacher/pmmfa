...
variance, namely, $\text{Var}[\Xi_j] = \tau^2$.
...
for risk class $j = 1, 2, \dots, J$ and $T$ is the number of
...
The risk class $j$ is characterized by a class risk profile
...
For state 1, the credibility slope is outside, and the intercept is 
inside the intervals defined by the stand-alone and collective
